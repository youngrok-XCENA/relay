...
assert_contains "$CLAUDE_CONTENT" 'project_description: "GitHub repository youngrok-XCENA/example"'
assert_contains "$CLAUDE_CONTENT" 'uses: youngrok-XCENA/relay/.github/workflows/claude.yml@main'
